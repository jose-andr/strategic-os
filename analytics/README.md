...
|---|---|---|
| Service Account | `analytics/service-account/` | First mature analytics pilot pattern for Strategic OS, including metric definitions, Genie context, review prompts, caveats and EOFY documentation support |
